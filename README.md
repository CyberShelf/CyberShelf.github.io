...
- کش تلگرام روزانه (هر ۲۴ ساعت) از صفحه عمومی و رسمی کانال با workflow فایل `.github/workflows/update-telegram-feed.yml` به‌روزرسانی می‌شود. اجرای workflow به دسترسی نوشتن Actions نیاز دارد.
